...
class App(tk.Tk):
    ...
    def clicked_dom(self):
        # pick up here... it's not adding this column
        
        print(self.dom_search().columns)
        try:
    ...
    def dom_search(self): 
        ...
        try:
            ...
            self.ref_match = self.df5.loc[self.df5["Domain"].isin(self.doms)]
            self.ref_match.insert(0, "Mitigate", ["Mitigate" for i in range(len(self.ref_match.index))])
            return self.ref_match
        except:
            return ValueError
    ...
    def check_all(self):
        ...
        print(self.sub_sheet.get_checkboxes())
